...
for row in rows:
	...
	mer_row = mer_rows[0]
	merchandise_img = "./imgs/" + str(mer_row[0]) + ".png"
...
for i in nums_lst:
	...
	recommend_img = "./imgs/" + str(i) + ".png"
	recommend_id = all_mer[0][0]
	recommend_name = all_mer[0][1]
	recommend_price = all_mer[0][2]
	...
	htmlText+='''
	    ...
	    '''%(recommend_img, recommend_name, recommend_name, recommend_price, recommend_id)
	    
htmlText+='''
	    <input type="button" onclick="location.href='./order.cgi'" value="注文画面へ">
	    </body>
	</html>
	'''
